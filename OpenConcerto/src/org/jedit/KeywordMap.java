...
/**
 * A <code>KeywordMap</code> is similar to a hashtable in that it maps keys to values. However,
 * the `keys' are Swing segments. This allows lookups of text substrings without the overhead of
