...
public class TextAreaDefaults
{
	...
	public  TextAreaDefaults getDefaults()
	{
		if(DEFAULTS == null)
		{
			...
			DEFAULTS.selectionColor = new JTextField().getSelectionColor();
			DEFAULTS.lineHighlightColor = new Color(232,242,254);
			DEFAULTS.lineHighlight = true;
			DEFAULTS.bracketHighlightColor = Color.DARK_GRAY;
