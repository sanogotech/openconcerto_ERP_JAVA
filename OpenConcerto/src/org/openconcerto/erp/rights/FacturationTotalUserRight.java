 ...
 * @author Ludo
 */
public class FacturationTotalUserRight extends FactureUserRight {

    public FacturationTotalUserRight() {
        super();
    }
    ...
    public List<RightTuple> expand(UserRightsManager mngr, String rightCode, String object, boolean haveRight) {
        ...
        res.add(new RightTuple(MENU, haveRight));
        res.add(new RightTuple(MENU_AVOIR, haveRight));
        return res;
    }
}
