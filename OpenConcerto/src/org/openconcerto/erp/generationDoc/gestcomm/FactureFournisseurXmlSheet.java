...
public class FactureFournisseurXmlSheet extends AbstractSheetXMLWithDate {
    ...
    public FactureFournisseurXmlSheet(SQLRow row) {
        super(row);
        this.printer = PrinterNXProps.getInstance().getStringProperty("CmdPrinter");
        this.elt = Configuration.getInstance().getDirectory().getElement("BON_RECEPTION");
    ...
    public String getName() {
        return "FactureFournisseur" + row.getString("NUMERO");
    }
}
