...
public class TransferSupplierOrderSQLElement extends ComptaSQLConfElement {

    public TransferSupplierOrderSQLElement() {
        super("TR_COMMANDE", "un transfert de commande fournisseur", "transferts de commande fournisseur");
    }
