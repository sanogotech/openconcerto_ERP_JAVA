...
public class TransferReceiptSQLElement extends ComptaSQLConfElement {

    public TransferReceiptSQLElement() {
        super("TR_BON_RECEPTION", "un transfert de bon de réception", "transferts de bon de réception");
    }
