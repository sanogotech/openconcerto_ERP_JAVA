...
public class NouvelHistoriqueListeClientAction extends CreateFrameAbstractAction {

    public NouvelHistoriqueListeClientAction() {
        super();
        this.putValue(Action.NAME, "Historique clients");
    }

    public JFrame createFrame() {
        HistoriqueClientFrame histoFrame = new HistoriqueClientFrame();

        return histoFrame.getFrame();
    }
}
