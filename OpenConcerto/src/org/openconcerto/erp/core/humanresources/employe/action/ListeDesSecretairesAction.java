...
public class ListeDesSecretairesAction extends CreateFrameAbstractAction {

    public ListeDesSecretairesAction() {
        super();
        this.putValue(Action.NAME, "Liste des secrétaires");
    }
