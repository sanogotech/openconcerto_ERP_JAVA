...
public class AssociationAnalytiqueKDTable extends JPanel {
    ...
    public AssociationAnalytiqueKDTable(final SQLRowValues defaultRow) {
        this(defaultRow, false);
    }

    public AssociationAnalytiqueKDTable(final SQLRowValues defaultRow, final boolean readOnly) {
        super();
        ...
        final RowValuesTableModel model = new AssociationAnalytiqueItemKDModel().getModel();
