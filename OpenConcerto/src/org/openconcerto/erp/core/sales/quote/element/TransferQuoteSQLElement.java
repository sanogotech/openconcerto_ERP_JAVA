...
public class TransferQuoteSQLElement extends ComptaSQLConfElement {

    public TransferQuoteSQLElement() {
        super("TR_DEVIS", "un transfert de devis", "transferts de devis");
    }

    @Override
    protected void ffInited() {
        setAction("ID_DEVIS", ReferenceAction.CASCADE);
