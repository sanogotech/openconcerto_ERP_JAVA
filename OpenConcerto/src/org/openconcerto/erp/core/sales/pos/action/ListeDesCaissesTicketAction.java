...
public class ListeDesCaissesTicketAction extends CreateFrameAbstractAction {

    public ListeDesCaissesTicketAction() {
        super();
        this.putValue(Action.NAME, "Liste des caisses");
    }
