...
public class TransferShipmentSQLElement extends ComptaSQLConfElement {

    public TransferShipmentSQLElement() {
        super("TR_BON_DE_LIVRAISON", "un transfert de bon de livraison", "transferts de bon de livraison");
    }
